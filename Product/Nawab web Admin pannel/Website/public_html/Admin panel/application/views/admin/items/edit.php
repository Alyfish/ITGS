...
<div class="form-group">
  ...
  <div class="col-sm-4">
    ...
    value="<?php echo set_value("name",html_entity_decode($items->name)); ?>"
...
<!-- Name End -->
	...
	<div class="form-group">
      ...
      foreach($cat as $key => $value): ?>
          ...
          <option value="<?php echo $value->cid; ?>" <?php echo $value->cid==$items->catid?'selected="selected"':""; ?>>
...
<div class="form-group">
  ...
  <div class="col-sm-4">
    ...
    value="<?php echo set_value("price",html_entity_decode($items->price)); ?>"
...
<div class="form-group">
  ...
  <div class="col-sm-4">
    ...
    <textarea class="form-control" id="desc" name="desc"><?php echo set_value("desc",html_entity_decode($items->desc)); ?></textarea>
